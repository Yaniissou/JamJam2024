...
# Utiliser un chemin absolu pour les fichiers
...
# Utilisation des chemins absolus pour les polices
titlefont = pygame.font.Font(os.path.join(current_dir, "./assets/fonts/RETROTECH.ttf"), 72)
textFont = pygame.font.Font(os.path.join(current_dir, "./assets/fonts/RETROTECH.ttf"), 48)
parentheseFont = pygame.font.Font(os.path.join(current_dir, "./assets/fonts/RETROTECH.ttf"), 24)
...
ruleBtn = Button(260, 680, pygame.image.load(os.path.join(current_dir, "assets/btn_regle_496.png")))
startButton = Button(window_width / 1.6, window_height / 1.50, pygame.image.load(os.path.join(current_dir, "./assets/btn_start.png")))
creditButton = Button(window_width / 1.6, window_height / 1.1, pygame.image.load(os.path.join(current_dir, "./assets/credits.png")))
backButton = Button(300, 200, pygame.image.load(os.path.join(current_dir, "./assets/retour.png")))

backButton.image = pygame.transform.scale(backButton.image, (150, 106))
nameButton = Button(window_width / 1.6, window_height / 1.25, pygame.image.load(os.path.join(current_dir, "./assets/btn_valider.png")))
countryBtnconfirm = Button(window_width / 1.1, window_height / 1.1, pygame.image.load(os.path.join(current_dir, "./assets/btn_valider.png")))
...
# Compétences des pays
competences = {0: 100, 1: 100, 2: 100, 3: 100, 4: 100, 5: 100}

# Chargement des pays
france = Pays("France", competences, pygame.image.load(os.path.join(current_dir, "assets/france.png")))
allemagne = Pays("Allemagne", competences, pygame.image.load(os.path.join(current_dir, "assets/allemagne.png")))
angleterre = Pays("Angleterre", competences, pygame.image.load(os.path.join(current_dir, "assets/uk.png")))
chine = Pays("Chine", competences, pygame.image.load(os.path.join(current_dir, "assets/chine.png")))
eu = Pays("Etats-Unis", competences, pygame.image.load(os.path.join(current_dir, "assets/etats_unis.png")))
russie = Pays("Russie", competences, pygame.image.load(os.path.join(current_dir, "assets/russie.png")))

selected_country = None

# Chargement de la carte tmx
tmx_data = pytmx.util_pygame.load_pygame(os.path.join(current_dir, "assets/map/tileset/1.tmx"))

# Fonctions de jeu (draw_map, get_collision_tiles, etc.)
# Assure-toi que tout ce qui est lié aux ressources utilise bien des chemins absolus comme ci-dessus.
...
def initMenu():
    background = pygame.image.load(os.path.join(current_dir, "./assets/menu-background.png"))
...
def selectCountry():
    ...
    imgPlayer = pygame.image.load(os.path.join(current_dir, "assets/testPlayer.png"))
...
def generate_items(length):
    ...
    for k in range(length):
        ...
        item = MapItem(x, y, pygame.image.load(os.path.join(current_dir, "./assets/testPlayer.png")))
